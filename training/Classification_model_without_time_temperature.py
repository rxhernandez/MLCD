...
dense_layer_1 = Dense(5, activation='elu')(input_layer)
dense_layer_2 = Dense(15, activation='elu')(dense_layer_1)
...
history = model.fit(X2, y_train, batch_size=8, epochs=3000, verbose=1, validation_split=0.25)
