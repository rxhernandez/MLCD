...
np.savetxt('Results/residuals_trainMachineB_2.dat', train_v)
np.savetxt('Results/residuals_train_numMachineB_2.dat', num_train_v)
np.savetxt('Results/residuals_testMachineB_2.dat', test_v)
np.savetxt('Results/residuals_test_numMachineB_2.dat', num_test_v)

train_v = np.loadtxt('Results/residuals_trainMachineB_2.dat')
num_train_v = np.loadtxt('Results/residuals_train_numMachineB_2.dat')
test_v = np.loadtxt('Results/residuals_testMachineB_2.dat')
num_test_v = np.loadtxt('Results/residuals_test_numMachineB_2.dat')
