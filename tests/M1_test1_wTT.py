...
np.savetxt('Results/test_set_trainMB_CDtestlit2_WTT.dat', train_v)
np.savetxt('Results/test_set_train_numMB_CDtestlit2_WTT.dat', num_train_v)
np.savetxt('Results/test_set_testMB_CDtestlit2_WTT.dat', test_v)
np.savetxt('Results/test_set_test_numMB_CDtestlit2_WTT.dat', num_test_v)


test_v = np.loadtxt('Results/test_set_testMB_CDtestlit2_WTT.dat')
num_test_v = np.loadtxt('Results/test_set_test_numMB_CDtestlit2_WTT.dat')
