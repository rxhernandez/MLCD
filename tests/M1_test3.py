...
np.savetxt('Results/test_set_trainMB_CDtestexp2_new.dat', train_v)
np.savetxt('Results/test_set_train_numMB_CDtestexp2_new.dat', num_train_v)
np.savetxt('Results/test_set_testMB_CDtestexp2_new.dat', test_v)
np.savetxt('Results/test_set_test_numMB_CDtestexp2_new.dat', num_test_v)


test_v = np.loadtxt('Results/test_set_testMB_CDtestexp2_new.dat')
num_test_v = np.loadtxt('Results/test_set_test_numMB_CDtestexp2_new.dat')
