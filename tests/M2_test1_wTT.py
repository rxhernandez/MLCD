...
np.savetxt('Results/residuals_trainMachineC_wTTC.dat', train_v)
np.savetxt('Results/residuals_train_numMachineC_wTTC.dat', num_train_v)
np.savetxt('Results/residuals_testMachineC_wTTC.dat', test_v)
np.savetxt('Results/residuals_test_numMachineC_wTTC.dat', num_test_v)
          
train_v = np.loadtxt('Results/residuals_trainMachineC_wTTC.dat')
num_train_v = np.loadtxt('Results/residuals_train_numMachineC_wTTC.dat')
test_v = np.loadtxt('Results/residuals_testMachineC_wTTC.dat')
num_test_v = np.loadtxt('Results/residuals_test_numMachineC_wTTC.dat')
