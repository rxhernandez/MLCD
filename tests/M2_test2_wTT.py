...
np.savetxt('Results/test_set_trainMC_CDtestexp2_wTTC.dat', train_v)
np.savetxt('Results/test_set_train_numMC_CDtestexp2_wTTC.dat', num_train_v)
np.savetxt('Results/test_set_testMC_CDtestexp2_wTTC.dat', test_v)
np.savetxt('Results/test_set_test_numMC_CDtestexp2_wTTC.dat', num_test_v)


test_v = np.loadtxt('Results/test_set_testMC_CDtestexp2_wTTC.dat')
num_test_v = np.loadtxt('Results/test_set_test_numMC_CDtestexp2_wTTC.dat')
