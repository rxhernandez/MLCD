...
np.savetxt('Results/test_set_trainMA_CDtestexp_wTTC_1sttest.dat', train_v)
np.savetxt('Results/test_set_train_numMA_CDtestexp_wTTC_1sttest.dat', num_train_v)
np.savetxt('Results/test_set_testMA_CDtestexp_wTTC_1sttest.dat', test_v)
np.savetxt('Results/test_set_test_numMA_CDtestexp_wTTC_1sttest.dat', num_test_v)

test_v = np.loadtxt('Results/test_set_testMA_CDtestexp_wTTC_1sttest.dat')
num_test_v = np.loadtxt('Results/test_set_test_numMA_CDtestexp_wTTC_1sttest.dat')
