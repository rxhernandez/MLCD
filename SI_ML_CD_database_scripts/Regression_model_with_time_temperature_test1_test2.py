...
np.savetxt('Fig/residuals_trainMachineB_2_WTT.dat', train_v)
np.savetxt('Fig/residuals_train_numMachineB_2_WTT.dat', num_train_v)
np.savetxt('Fig/residuals_testMachineB_2_WTT.dat', test_v)
np.savetxt('Fig/residuals_test_numMachineB_2_WTT.dat', num_test_v)

train_v = np.loadtxt('Fig/residuals_trainMachineB_2_WTT.dat')
num_train_v = np.loadtxt('Fig/residuals_train_numMachineB_2_WTT.dat')
test_v = np.loadtxt('Fig/residuals_testMachineB_2_WTT.dat')
num_test_v = np.loadtxt('Fig/residuals_test_numMachineB_2_WTT.dat')
...
#writing these values to a file
np.savetxt('Fig/test_set_trainMB_CDtestlit2_WTT.dat', train_v)
np.savetxt('Fig/test_set_train_numMB_CDtestlit2_WTT.dat', num_train_v)
np.savetxt('Fig/test_set_testMB_CDtestlit2_WTT.dat', test_v)
np.savetxt('Fig/test_set_test_numMB_CDtestlit2_WTT.dat', num_test_v)

#train_v = np.loadtxt('Figures/residuals_train.dat')
#num_train_v = np.loadtxt('Figures/residuals_train_num.dat')
test_v = np.loadtxt('Fig/test_set_testMB_CDtestlit2_WTT.dat')
num_test_v = np.loadtxt('Fig/test_set_test_numMB_CDtestlit2_WTT.dat')
...
#writing these values to a file
np.savetxt('Fig/test_set_trainMB_CDtestexp2_WTT.dat', train_v)
np.savetxt('Fig/test_set_train_numMB_CDtestexp2_WTT.dat', num_train_v)
np.savetxt('Fig/test_set_testMB_CDtestexp2_WTT.dat', test_v)
np.savetxt('Fig/test_set_test_numMB_CDtestexp2_WTT.dat', num_test_v)

#train_v = np.loadtxt('Figures/residuals_train.dat')
#num_train_v = np.loadtxt('Figures/residuals_train_num.dat')
test_v = np.loadtxt('Fig/test_set_testMB_CDtestexp2_WTT.dat')
num_test_v = np.loadtxt('Fig/test_set_test_numMB_CDtestexp2_WTT.dat')
