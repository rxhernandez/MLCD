...
np.savetxt('Fig/residuals_trainMachineA_wTTC.dat', train_v)
np.savetxt('Fig/residuals_train_numMachineA_wTTC.dat', num_train_v)
np.savetxt('Fig/residuals_testMachineA_wTTC.dat', test_v)
np.savetxt('Fig/residuals_test_numMachineA_wTTC.dat', num_test_v)

train_v = np.loadtxt('Fig/residuals_trainMachineA_wTTC.dat')
num_train_v = np.loadtxt('Fig/residuals_train_numMachineA_wTTC.dat')
test_v = np.loadtxt('Fig/residuals_testMachineA_wTTC.dat')
num_test_v = np.loadtxt('Fig/residuals_test_numMachineA_wTTC.dat')
...
#writing these values to a file
np.savetxt('Fig/test_set_trainMA_CDtestlit_wTTC.dat', train_v)
np.savetxt('Fig/test_set_train_numMA_CDtestlit_wTTC.dat', num_train_v)
np.savetxt('Fig/test_set_testMA_CDtestlit_wTTC.dat', test_v)
np.savetxt('Fig/test_set_test_numMA_CDtestlit_wTTC.dat', num_test_v)
          
#train_v = np.loadtxt('Figures/residuals_train.dat')
#num_train_v = np.loadtxt('Figures/residuals_train_num.dat')
test_v = np.loadtxt('Fig/test_set_testMA_CDtestlit_wTTC.dat')
num_test_v = np.loadtxt('Fig/test_set_test_numMA_CDtestlit_wTTC.dat')
...
##################
#writing these values to a file
np.savetxt('Fig/test_set_trainMA_CDtestexp_wTTC.dat', train_v)
np.savetxt('Fig/test_set_train_numMA_CDtestexp_wTTC.dat', num_train_v)
np.savetxt('Fig/test_set_testMA_CDtestexp_wTTC.dat', test_v)
np.savetxt('Fig/test_set_test_numMA_CDtestexp_wTTC.dat', num_test_v)

#train_v = np.loadtxt('Figures/residuals_train.dat')
#num_train_v = np.loadtxt('Figures/residuals_train_num.dat')
test_v = np.loadtxt('Fig/test_set_testMA_CDtestexp_wTTC.dat')
num_test_v = np.loadtxt('Fig/test_set_test_numMA_CDtestexp_wTTC.dat')
