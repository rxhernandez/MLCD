...
CD1 = CD.drop(['Example ID', 'DOI', 'Color', 'Reaction temperatrue( C )', 'reaction time (min)', 'particle size (TEM)', 'Lattice obrserved or not', 'absorption', 'HCl', 'formic acid '], axis=1)
...
np.savetxt('Fig/residuals_trainMachineA_woTT_test2Xiao.dat', train_v)
np.savetxt('Fig/residuals_train_numMachineA_woTT_test2Xiao.dat', num_train_v)
np.savetxt('Fig/residuals_testMachineA_woTT_test2Xiao.dat', test_v)
np.savetxt('Fig/residuals_test_numMachineA_woTT_test2Xiao.dat', num_test_v)

train_v = np.loadtxt('Fig/residuals_trainMachineA_woTT_test2Xiao.dat')
num_train_v = np.loadtxt('Fig/residuals_train_numMachineA_woTT_test2Xiao.dat')
test_v = np.loadtxt('Fig/residuals_testMachineA_woTT_test2Xiao.dat')
num_test_v = np.loadtxt('Fig/residuals_test_numMachineA_woTT_test2Xiao.dat')
...
plt.errorbar(avg_test_v, X2['Main Peak (in water)'], xerr=std_test_err, 
...
train_v = np.zeros((X2.shape[0], modelnum))
num_train_v = np.zeros((X2.shape[0]))
test_v = np.zeros((CD_test_lit.shape[0], modelnum))
num_test_v = np.zeros((CD_test_lit.shape[0]))
...
for i in range(modelnum):
    ...
    train = X2.sample(frac=3/4, random_state=i)
    test = CD_test_lit#CSN_prepared.loc[~CSN_prepared.index.isin(train.index), :]
    ...
    nall_f = norm(CD_test_lit.drop(['Main Peak (in water)'], axis=1), train_f)
...
#########################
#writing these values to a file
np.savetxt('Fig/test_set_trainMA_CDtestlit_woTT_test2Xiao.dat', train_v)
np.savetxt('Fig/test_set_train_numMA_CDtestlit_woTT_test2Xiao.dat', num_train_v)
np.savetxt('Fig/test_set_testMA_CDtestlit_woTT_test2Xiao.dat', test_v)
np.savetxt('Fig/test_set_test_numMA_CDtestlit_woTT_test2Xiao.dat', num_test_v)

#train_v = np.loadtxt('Figures/residuals_train.dat')
#num_train_v = np.loadtxt('Figures/residuals_train_num.dat')
test_v = np.loadtxt('Fig/test_set_testMA_CDtestlit_woTT_test2Xiao.dat')
num_test_v = np.loadtxt('Fig/test_set_test_numMA_CDtestlit_woTT_test2Xiao.dat')
...
test_err = np.where(np.isclose(test_v,0), 0, (test_v.T-CD_test_lit['Main Peak (in water)'].values).T)
...
print('train', rc(avg_train_v, X2['Main Peak (in water)']))
print('test', rc(avg_test_v, CD_test_lit['Main Peak (in water)']))

print(stats.linregress(avg_test_v, CD_test_lit['Main Peak (in water)']))
m, b = sp.stats.linregress(avg_test_v, CD_test_lit['Main Peak (in water)'])[0:2]
...
#writing these values to a file
np.savetxt('Fig/test_set_trainMA_CDtestexp_woTT_test2Xiao.dat', train_v)
np.savetxt('Fig/test_set_train_numMA_CDtestexp_woTT_test2Xiao.dat', num_train_v)
np.savetxt('Fig/test_set_testMA_CDtestexp_woTT_test2Xiao.dat', test_v)
np.savetxt('Fig/test_set_test_numMA_CDtestexp_woTT_test2Xiao.dat', num_test_v)

#train_v = np.loadtxt('Figures/residuals_train.dat')
#num_train_v = np.loadtxt('Figures/residuals_train_num.dat')
test_v = np.loadtxt('Fig/test_set_testMA_CDtestexp_woTT_test2Xiao.dat')
num_test_v = np.loadtxt('Fig/test_set_test_numMA_CDtestexp_woTT_test2Xiao.dat')
