...
np.savetxt('Fig/test_set_trainMB_CDtestexp2_new.dat', train_v)
np.savetxt('Fig/test_set_train_numMB_CDtestexp2_new.dat', num_train_v)
np.savetxt('Fig/test_set_testMB_CDtestexp2_new.dat', test_v)
np.savetxt('Fig/test_set_test_numMB_CDtestexp2_new.dat', num_test_v)

#train_v = np.loadtxt('Figures/residuals_train.dat')
#num_train_v = np.loadtxt('Figures/residuals_train_num.dat')
test_v = np.loadtxt('Fig/test_set_testMB_CDtestexp2_new.dat')
num_test_v = np.loadtxt('Fig/test_set_test_numMB_CDtestexp2_new.dat')
