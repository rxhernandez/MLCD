...
def load_CD_data():
    #csv_path = CSN_path + "Train407_test15byExp_with_Pred_Color_okone_1sttest_csv.csv"
...
np.savetxt('Fig/test_set_trainMA_CDtestexp_wTTC_1sttest.dat', train_v)
np.savetxt('Fig/test_set_train_numMA_CDtestexp_wTTC_1sttest.dat', num_train_v)
np.savetxt('Fig/test_set_testMA_CDtestexp_wTTC_1sttest.dat', test_v)
np.savetxt('Fig/test_set_test_numMA_CDtestexp_wTTC_1sttest.dat', num_test_v)

#train_v = np.loadtxt('Figures/residuals_train.dat')
#num_train_v = np.loadtxt('Figures/residuals_train_num.dat')
test_v = np.loadtxt('Fig/test_set_testMA_CDtestexp_wTTC_1sttest.dat')
num_test_v = np.loadtxt('Fig/test_set_test_numMA_CDtestexp_wTTC_1sttest.dat')
