...
def load_CD_data():
    #csv_path = CSN_path + "Train407_test15byExp_withTimeTemp_with_Pred_Color_csv.csv"
    csv_path = CSN_path + "ML_CD_database_test1_test2_with_Pred_Color_csv.csv"
...
def load_CD_data():
    #csv_path = CSN_path + "Train407_test15byExp_withTimeTemp_with_Pred_Color_only_csv.csv"
    csv_path = CSN_path + "ML_CD_database_test1_test2_with_Pred_Color_only_csv.csv"
    return pd.read_csv(csv_path)
...
np.savetxt('Fig/residuals_trainMachineC_wTTC.dat', train_v)
np.savetxt('Fig/residuals_train_numMachineC_wTTC.dat', num_train_v)
np.savetxt('Fig/residuals_testMachineC_wTTC.dat', test_v)
np.savetxt('Fig/residuals_test_numMachineC_wTTC.dat', num_test_v)
          
train_v = np.loadtxt('Fig/residuals_trainMachineC_wTTC.dat')
num_train_v = np.loadtxt('Fig/residuals_train_numMachineC_wTTC.dat')
test_v = np.loadtxt('Fig/residuals_testMachineC_wTTC.dat')
num_test_v = np.loadtxt('Fig/residuals_test_numMachineC_wTTC.dat')
...
#####################
#writing these values to a file
np.savetxt('Fig/test_set_trainMC_CDtestlit2_wTTC.dat', train_v)
np.savetxt('Fig/test_set_train_numMC_CDtestlit2_wTTC.dat', num_train_v)
np.savetxt('Fig/test_set_testMC_CDtestlit2_wTTC.dat', test_v)
np.savetxt('Fig/test_set_test_numMC_CDtestlit2_wTTC.dat', num_test_v)
          
#train_v = np.loadtxt('Figures/residuals_train.dat')
#num_train_v = np.loadtxt('Figures/residuals_train_num.dat')
test_v = np.loadtxt('Fig/test_set_testMC_CDtestlit2_wTTC.dat')
num_test_v = np.loadtxt('Fig/test_set_test_numMC_CDtestlit2_wTTC.dat')
...
#writing these values to a file
np.savetxt('Fig/test_set_trainMC_CDtestexp2_wTTC.dat', train_v)
np.savetxt('Fig/test_set_train_numMC_CDtestexp2_wTTC.dat', num_train_v)
np.savetxt('Fig/test_set_testMC_CDtestexp2_wTTC.dat', test_v)
np.savetxt('Fig/test_set_test_numMC_CDtestexp2_wTTC.dat', num_test_v)

#train_v = np.loadtxt('Figures/residuals_train.dat')
#num_train_v = np.loadtxt('Figures/residuals_train_num.dat')
test_v = np.loadtxt('Fig/test_set_testMC_CDtestexp2_wTTC.dat')
num_test_v = np.loadtxt('Fig/test_set_test_numMC_CDtestexp2_wTTC.dat')
